    ...
    <div class="section-body">
      ...
      <div class="form-modal-wrapper" style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #fff; border-radius: 10px; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.3);">
        <form action="{{route('submit-form')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label>Enter Book Reviews</label>
            <input type="number" class="form-control" placeholder="Enter Book Reviews" name="reviews">
          </div>

          <div class="form-group">
            <label>Enter Book Description</label>
            <div class="input-group">
              <textarea class="form-control" placeholder="Enter Book Description" name="des"></textarea>
            </div>
          </div>
