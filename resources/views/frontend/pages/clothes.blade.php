...
<div class="products">
    <div class="container" data-aos="fade-right" data-aos-duration="500" >
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 all des" data-aos="fade-right" data-aos-duration="500">
                   <div class="filters-content">
                    <div class="product-item">
                        <a href="{{route('products-details-clothes' , $record->id)}}"><img src="{{ asset('Clothes/' . $record->image) }}" alt="" class="img-fluid" style="width: 100%; height: 300px; object-fit: cover;"></a>
